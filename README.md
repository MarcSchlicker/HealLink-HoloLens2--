...
The HoloLens 2 project is the mixed-reality endpoint of HealLink. It runs on HoloLens 2 and provides the device-side Unity scene, MRTK/OpenXR setup, and networking components needed to exchange data with the other HealLink parts.
